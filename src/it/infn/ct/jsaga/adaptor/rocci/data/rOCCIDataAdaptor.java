                       ...
                       TimeoutException, NoSuccessException 
  {
	try {
        	m_conn = new Connection(host, port);
                ...
                String userId = ((rOCCISecurityCredential) credential)
                        .getSSHCredential()
                        .getUserId();
                
                String passPhrase = ((rOCCISecurityCredential) credential)
                        .getSSHCredential()
                        .getUserPass();
                
                // clone private key because the object will be reset
                byte[] privateKey = ((rOCCISecurityCredential) credential)
                        .getSSHCredential()
                        .getPrivateKey()
                        .clone();
